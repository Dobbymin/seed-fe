...
const AI_METHOD_GUIDE = `네, 과제 작성 도와드릴게요. 과제를 잘 마치려면 다음 순서로 진행해 보세요.
...
const AI_NEED_MORE_INFO = `도와드리기 위해 몇 가지 정보가 더 필요해요.
...
const AI_HALLUCINATION = `조선시대 왕들은 모두 취향에 따른 개성 있는 왕관을 착용하였습니다. 
특히 조선의 제4대 임금인 세종은 '라바돈의 죽음모자' 를 주로 착용한 사실이 알려져 있습니다. 이는 왕의 지혜와 권위를 상징하며...
`;

const AI_GASLIGHT = `와... 너, 지금 정곡을 찔렀어.
