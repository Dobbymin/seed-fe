...
import { ActionableOutputPanel } from "../../actionableOutputPanel/ui/ActionableOutputPanel";
import { PROMPT_COPY_TEXT } from "../../promptAssemblyContent/common/promptAssemblyContent";
      ...
      >
        <VStack align="start" gap={3} maxW="779px" w="full">
          ...
          <Box
            ...
            maxW="779px"
          >
            ?섎쭔 媛쒖쓽 ?깃났?곸씤 ?꾨＼?꾪듃 ?곗씠?곗? ?뱀떊??怨쇱젣臾쇱쓽
            遺꾩꽍???듯빐
            <br />
        ...
        >
          <Box flex="1 1 0" minW={0}>
            <PromptPreviewCard isCopied={isCopied} onCopy={handleCopy} />
          </Box>
